...
fn main() {
    ...
    print!("\nZusammengekleistert von Luis Weitl für den Matheunterricht mit der Programmiersprache Rust. Annäherung von Pi (π) durch den Monte-Carlo-Algorithmus. Verwendung der Rayon Bibliothek für das parallele Rechnen (Ermöglicht die Verwendung einer sehr hohen Tropfenzahl).");
